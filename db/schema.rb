...
ActiveRecord::Schema.define(version: 20_170_810_065_257) do
  ...
  create_table 'pictures', force: :cascade do |t|
    ...
    t.index ['company_id'], name: 'index_pictures_on_company_id', using: :btree
  end
  ...
  add_foreign_key 'pictures', 'companies'
